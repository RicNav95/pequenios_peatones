...
public class MiniJuego_puente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pantalla_minijuego_puente);
        ...
        cursorpreguntas = db.rawQuery("SELECT * FROM Preguntas WHERE Apartado='Semaforo'", null);
    ...
    private void mostrar_preguntas() {
        if (cursorpreguntas.moveToPosition(pregunta_actual)) {
            ...
            if (respuestas_correctas > respuestas_incorrectas) {
                Intent i = new Intent(MiniJuego_puente.this, Recompensa.class);
                startActivity(i);
                finish();
            } else {
                Intent i = new Intent(MiniJuego_puente.this, Fallo_Puente.class);
                startActivity(i);
                finish();
            }
