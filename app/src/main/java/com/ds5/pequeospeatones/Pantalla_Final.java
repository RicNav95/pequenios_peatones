...
public class Pantalla_Final extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagenes = findViewById(R.id.questionImageView);

        ClaseSQLite1 clase = new ClaseSQLite1(this, "Datos-Generales", null, 1);
        SQLiteDatabase db = clase.getReadableDatabase();
        cursorpreguntas = db.rawQuery("SELECT * FROM Preguntas WHERE Apartado='Prueba Final'", null);
    ...
    private void mostrar_preguntas() {
        if (cursorpreguntas.moveToPosition(pregunta_actual)) {
            ...
            Intent i = new Intent(Pantalla_Final.this, Ranking.class);
            i.putExtra("Correctas", respuestas_correctas);
            startActivity(i);
            finish();
        }
    }
