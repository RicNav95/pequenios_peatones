...
public class Minijuego_cebra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pantalla_minijuego_cebra);
    ...
    private void mostrar_preguntas() {
        if (cursorpreguntas.moveToPosition(pregunta_actual)) {
            ...
            if (respuestas_correctas > respuestas_incorrectas) {
                Intent i = new Intent(Minijuego_cebra.this, Recompensa.class);
                startActivity(i);
                finish();
            } else {
                Intent i = new Intent(Minijuego_cebra.this, Fallo_Cebra.class);
                startActivity(i);
                finish();
            }
